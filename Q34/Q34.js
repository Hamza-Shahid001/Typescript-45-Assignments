// Favourite Pizza
var favourite_pizza = ['Afghani Tikka', 'Malai boti', 'Fajita'];
for (var i = 0; i < favourite_pizza.length; i++) {
    console.log(favourite_pizza[i]);
} // For loop to print each Pizza flavor names
for (var i = 0; i < favourite_pizza.length; i++) { // For loop to print message on each flavor
